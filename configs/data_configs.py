...
DATASETS = {
    ...
    'dog_and_cat_encode': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['dog_and_cat_train'],
		'train_target_root': dataset_paths['dog_and_cat_train'],
		'test_source_root': dataset_paths['dog_and_cat_val'],
		'test_target_root': dataset_paths['dog_and_cat_val'],
	}
}
